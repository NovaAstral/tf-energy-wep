...
SWEP.PrintName = "Thermo Missiles"
...
timer.Simple(0.1, function() weapons.Register(SWEP,"tf_wep_thermo_missiles", true) end) --Putting this in a timer stops bugs from happening if the weapon is given while the game is paused