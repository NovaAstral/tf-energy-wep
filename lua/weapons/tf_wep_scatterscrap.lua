...
function SWEP:Initialize()
    ...
    self.ShotColor = Color(231,132,0,215) --muzzle fx color must be set manually because gmod and im lazy
end
...
if(SERVER) then
    function SWEP:DoShooty()
        ...
        for I=1,10 do
            local multiply = 1000 -- Default inaccuracy multiplier
        ...
        ply:EmitSound(Sound("cybertronian/tfshotgunshoot.wav"), 90, math.random(97, 103))
    end
...
timer.Simple(0.1, function() weapons.Register(SWEP,"tf_wep_scatterscrap", true) end) --Putting this in a timer stops bugs from happening if the weapon is given while the game is paused