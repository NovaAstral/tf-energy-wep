...
function SWEP:Initialize()
    ...
    self.ShotColor = Color(0,231,217,215)
end
...
if(SERVER) then
    function SWEP:DoShooty()
        ...
        ply:EmitSound(Sound("cybertronian/tfnuetronshoot.wav"), 90, math.random(97, 103))
    end
...
timer.Simple(0.1, function() weapons.Register(SWEP,"tf_wep_omega_neutron", true) end) --Putting this in a timer stops bugs from happening if the weapon is given while the game is paused