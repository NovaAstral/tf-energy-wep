...
SWEP.PrintName = "Toxin Corrosion"
...
SWEP.DrawAmmo = true
SWEP.WorldModel = "models/megarexfoc/w_mafoc_toxic.mdl"
SWEP.ViewModel = "models/megarexfoc/viewmodels/c_foc_slime_cannon.mdl"

SWEP.Category = "Transformers Weapons"

SWEP.FOCEquip = Sound("cybertronian/tfslime_equip.wav")
SWEP.FOCHolster = Sound("cybertronian/tfslime_holster.wav")
...
function SWEP:Initialize()
    ...
    self.ShotColor = Color(0,187,0,215)
end
...
if(SERVER) then
    function SWEP:DoShooty()
        ...
        ply:EmitSound(Sound("cybertronian/tfslime_shoot.wav"), 90, math.random(97, 103))
    end
...
timer.Simple(0.1, function() weapons.Register(SWEP,"tf_wep_toxin_corrosion", true) end) --Putting this in a timer stops bugs from happening if the weapon is given while the game is paused